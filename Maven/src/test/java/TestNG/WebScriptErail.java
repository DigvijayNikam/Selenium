...
public class WebScriptErail {
	...
	public void testCase1()
	{
		...
		String expectedTitle="Home |  IRCTC: Order Food on Train Online, Food and Meal on Train, Tasty Food for Train Journey";
				String actualTitle=driver.getTitle();
				
				//below code won't fail your Test case even if validation is failed
				
				/*if(actualTitle.equals(expectedTitle)) {
					System.out.println(" Print TC passed");
				}
				else
				{
